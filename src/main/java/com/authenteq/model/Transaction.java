...
public class Transaction {
	 ...
	 */
	public Transaction(JSONObject data, JSONObject metadata, EdDSAPublicKey publicKey) {
	 ...
	 */
	private Transaction(JSONObject data, JSONObject metadata, JSONObject transactionJson,
	...
	public static Transaction createFromJson(JSONObject jsonObject) {
		...
		return new Transaction(data, metadata, jsonObject, edDSAPublicKey, signed);
	}
	 ...
	 * @return the list
	 */
	public static List<Transaction> createFromJsonArray(JSONArray jsonArray) {
		List<Transaction> bigChaindbTransactionList = new ArrayList<Transaction>();
		...
		while (jsonObjectIter.hasNext()) {
			...
			bigChaindbTransactionList.add(new Transaction(data, metadata, jsonObject, edDSAPublicKey, signed));
		}
